...
<div class="viewmain">
 		...
 		<div class="viewcontent">
 			<p id="viewhead">Approve Request</p>
 			...
 			<p id="detailhead">Date Registratered : <?php echo $row['data_reg']; ?></p>
								...
								<h5 id="viewhead">Monthly Salary</h5>
								<?php
									...
									if(isset($_POST['update'])){
										...
										$q = "UPDATE doctors SET salary='$salary',status='Approved' WHERE id='$id'";
								...
								<div class="profformfield spaced">
									...
									<input type="number" name="salary" class="#" autocomplete="off" placeholder="Enter Doctor's Salary" value="0">
								</div>
									<input type="submit" name="update" class="pbtm" value="Pay it">
								</form>
