...
if (isset($_POST['add_instrument'])) {
    ...
    if (empty($iname)) {
        ...
        $error['ac'] = "Enter Price";
    }

    if (count($error) == 0) {

        $query = "INSERT INTO inventory(instrument_id,instrument_name,quantity,price,model_no) VALUES('','$iname','$qua','$price','$model')";
    ...
    <div class="admdinmain">
      ...
      ";
          ...
          ";
            ...
            <div class="mdinsub2">
                <p id="admdinhead">Add Medical Instruments</p>
                <form method="post">
                    ...
                    <div class="mdinfformfield spaced">
                        <label>Price</label>
                        <input type="number" name="price" class="" autocomplete="off" placeholder="Enter Price" value="<?php if (isset($_POST['price'])) echo $_POST['price']; ?>">
                    </div>
                    <div class="mdinfformfield spaced">
                    ...
                    <input type="submit" name="add_instrument" value="Submit" class="pbtm">
                </form>
